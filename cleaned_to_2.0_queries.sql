...
INSERT INTO [Top2000_2.0].dbo.SONG (ARTIST_NAME, SONG_NAME, RELEASE_YEAR, DURATION)
...
INSERT INTO [Top2000_2.0].dbo.FEATURINGARTISTOFSONG (SONG_NAME, SON_ARTIST_NAME, ARTIST_NAME)
...
INSERT INTO [Top2000_2.0].dbo.TOP2000LIST (EDITION_YEAR)
SELECT DISTINCT edition_year
FROM Top2000_cleaned.dbo.Top2000Lijst
GO

INSERT INTO [Top2000_2.0].dbo.TOP2000LISTENTRY (ARTIST_NAME, SONG_NAME, EDITION_YEAR, POSITION)
SELECT artist as ARTIST_NAME, titel as SONG_NAME, edition_year as EDITION_YEAR, position as POSITION
FROM Top2000_cleaned.dbo.Top2000Lijst
GO

INSERT INTO [Top2000_2.0].dbo.GENRE (GENRE_NAME)
SELECT genre_name as GENRE_NAME
FROM Top2000_cleaned.dbo.Genre
GO

INSERT INTO [Top2000_2.0].dbo.GENREOFSONG (GENRE_NAME, ARTIST_NAME, SONG_NAME)
...
INSERT INTO [Top2000_2.0].dbo.PERSON (ARTIST_NAME, PERSON_NAME)
SELECT componist_name as ARTIST_NAME, componist_name as PERSON_NAME
FROM Top2000_cleaned.dbo.Componist
GO

INSERT INTO [Top2000_2.0].dbo.COMPOSER (ARTIST_NAME, PERSON_NAME)
SELECT componist_name as ARTIST_NAME, componist_name as PERSON_NAME
FROM Top2000_cleaned.dbo.Componist
GO

INSERT INTO [Top2000_2.0].dbo.COMPOSEROFSONG (SON_ARTIST_NAME, SONG_NAME, ARTIST_NAME, PERSON_NAME)
